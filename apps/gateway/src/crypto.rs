...
mod tests {
    ...
    // Generated by Node.js crypto (see docs/crypto-format.md).
    // Proves the Rust decrypter is wire-format-compatible with the
    // TypeScript encrypter. If this test fails, the wire format has
    // diverged between implementations and at-rest secrets become
    // unreadable across the boundary.

    const FIXTURE_KEY_B64: &str = "YWJjZGVmZ2hpamtsbW5vcHFyc3R1dnd4eXoxMjM0NTY=";
    const FIXTURE_PLAINTEXT: &str = "sk-ant-api03-cross-validation-test-key";
    ...
    async fn decrypt_nodejs_fixture() {
        ...
        let decrypted = service
            ...
            .await
            .expect("decrypt Node.js fixture");
